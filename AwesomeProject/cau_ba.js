...
export default function cau_ba() {
    return (
        <View style={styles.container}>
            <View style={styles.textGroup}>
                <box-icon name='lock' style={{width: 105, height: 117}} size='lg'></box-icon>
            ...
            <View>
                <box-icon style={{marginBottom: -55, marginLeft: 20, width: 30}} name='envelope' size='lg'></box-icon>
                <TextInput
                    style={styles.textInput}
                    placeholder='Email'
                    inlineImageLeft='../assets/mail.png'
                />
            </View>
